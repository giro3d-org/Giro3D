...
describe('initialize', () => {
    it('should always return the same promise to avoid concurrent initializations', () => {
        ...
        // We have to put the catch here and not chained to initialize(),
        // otherwise this would create two distinct promises, which would fail the test.
        const ignore = () => {
            /* ignore this */
        };
        promise1.catch(ignore);
        promise2.catch(ignore);
