...
function triangulate(flatCoordinates: ArrayLike<number>, holeIndices: ArrayLike<number>) {
    ...
    const matrix = tris.matrix.lookAt(tris.a, plane.normal.add(tris.a), new Vector3(0, 0, 1));
